...
| **Projects** | View repository and organization projects |
| **Repository security advisories** | View security advisories |
| **Vulnerability alerts** | View Dependabot alerts |
| **Dependabot secrets** | View Dependabot secrets for dependency updates |
