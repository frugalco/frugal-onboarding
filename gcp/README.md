...
Example:
```bash
./frugal-gcp-setup.sh frugal-gcp-readonly my-project-123 --impersonate frugal-console@staging-467615.iam.gserviceaccount.com
```
...
./frugal-gcp-setup.sh frugal-readonly my-primary-project \
  --impersonate frugal-console@staging-467615.iam.gserviceaccount.com \
